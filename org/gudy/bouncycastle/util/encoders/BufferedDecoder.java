...
/*    */     {
/* 47 */       resultLen = this.translator.decode(this.buf, 0, this.buf.length, out, outOff);
/* 48 */       this.bufOff = 0;
/*    */     }
/*    */     
/* 51 */     return resultLen;
...
/*    */       
/* 73 */       resultLen += this.translator.decode(this.buf, 0, this.buf.length, out, outOff);
/*    */       
/* 75 */       this.bufOff = 0;
/*    */       
/* 77 */       len -= gapLen;
...
/*    */       
/* 83 */       resultLen += this.translator.decode(in, inOff, chunkSize, out, outOff);
/*    */       
/* 85 */       len -= chunkSize;
/* 86 */       inOff += chunkSize;
/*    */     }
...
/* Location:              /Users/Shared/Library/Application Support/Vuze/Azureus2.jar!/org/gudy/bouncycastle/util/encoders/BufferedDecoder.class
